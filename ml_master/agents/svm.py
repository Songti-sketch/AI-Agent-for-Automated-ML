...
To complete the task, you need to use support vector machine to implement the task.

Please follow these steps to complete the task:
1. Analyze the data provided in the input using pandas and numpy.
2. Based on the analysis, implement the task using Support Vector Machine.
...
svm_implementor = _parse_prob_to_desc_prompt | prompt | model | StrOutputParser() | extract_python_code
svm_implementor.__doc__ = (
    """
