...
To complete the task, you need to use Neural Network to implement the task.

Please follow these steps to complete the task:
1. Analyze the data provided in the input using pandas and numpy.
2. Based on the analysis, implement the task using Neural Network.
3. Use either sklearn or PyTorch. DON'T use tensorflow.
4. Use sklearn only for tiny models. Use PyTorch with GPU with slightly larger ones. 
...
Param search for neural network is VERY expensive. Select your search space carefully.
"""
...
nn_implementor = _parse_prob_to_desc_prompt | prompt | model | StrOutputParser() | extract_python_code
nn_implementor.__doc__ = (
    """
